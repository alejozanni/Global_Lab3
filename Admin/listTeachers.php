        ...
        <div class="row flex-nowrap">
          ...
          <div class="col py-3" style="background-color:#c8d2e6">
            <header class="navbar justify-content-start sticky-top flex-md-nowrap p-0">
              <div>
                <h3 class="navbarText">Lista de doctores</h3>
              </div>
            ...
            <div class="containerListDoctors">
                ...
                <table class="table table-hover" id="tableDoctorManagement">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="editDoctor.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
                                <a href="listDoctors.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Seguro que quiere eliminar este doctor?')" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
                            </td>
                        </tr>
