...
<?php
  ...
  if(isset($_POST['submit'])){	
    ...
    $sql=mysqli_query($con,"insert into teachers(teacherName,password) values('$username','$password')");
    
    if($sql){
      echo "<script>alert('Teacher info added Successfully');</script>";
      echo "<script>window.location.href ='listTeachers.php'</script>";
    }
  }
?>
            ...
            <div class="d-flex flex-column px-3 pt-2 text-white min-vh-100">
              ...
              <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                <li class="nav-item">
                  ...
                  <a href="addTeacher.php" class="nav-link align-middle px-0">
                  ...
                  <a href="TeacherSearch.php" class="nav-link align-middle px-0">
          ...
          <div class="col py-3" style="background-color:#c8d2e6">
            ...
            <div class="containerAddDoctor">
                <div class="form-floating">
                  <input type="text" name="teacherName" class="form-control"  placeholder="Nombre completo" required="true" id="floatingTextarea">
                ...
                <button type="submit" name="submit" id="submit" class="btn btn-primary">Agregar</button>
              </form>
            </div>
